...
export default function CookieConsent() {
    ...
    return (
        <div className="fixed inset-0 z-[9999] bg-black/70 flex items-end justify-start">
            ...
            {/* Bottom Bar (only clickable area) */}
            <div className="w-full bg-black text-white px-6 py-4 h-40 flex flex-col  items-start justify-between gap-4 pointer-events-auto">

                <p className="text-md  text-center font-light md:text-left">
                    We use cookies to enhance your experience, analyze site usage, and assist in our marketing efforts.
                    By clicking Accept, you agree to our use of cookies.<br></br> You can manage your preferences or reject non-essential cookies at any time.
                </p>
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="px-9 py-3 rounded-4xl  group relative px-6 py-3 rounded-full 
   ...
   <span
        ...
        ></span>
                        ...
                        className="px-9 py-3 rounded-4xl border border-white/30 hover:bg-white/10"
                    >
                        Reject
                    </button>
                </div>
