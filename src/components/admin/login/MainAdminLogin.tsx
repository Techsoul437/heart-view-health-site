...
const features = [
  { icon: ShieldCheck, title: "Lab onboarding & verification" },
  { icon: ClipboardList, title: "Report monitoring & review" },
  { icon: ScrollText, title: "Audit logs & compliance" },
  { icon: Settings2, title: "System administration tools" },
];
  ...
  return (
    <>
      ...
      <p className="mt-8 text-center text-sm text-[#94A3B8]">
        Admin accounts are by invitation only. Contact your system
