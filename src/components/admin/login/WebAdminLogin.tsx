...
const features = [
  { icon: FileHeart, title: "Inquiries" },
  { icon: ShieldCheck, title: "Blogs" },
  { icon: BadgeCheck, title: "Team Members" },
    ...
    <div className="relative z-10 flex h-full flex-col p-7 xl:p-9 gap-6">
      ...
      <div className="shrink-0">
        ...
        <p className="mt-3 hidden lg:block leading-6 text-[#64748B] text-sm">
         Manage website content, inquiries, blogs, and team members from one secure dashboard.
        </p>
      </div>
    ...
    <>
      <div className="mb-7">
        ...
        <p className="mt-2 text-[#94A3B8] ">
          Sign in to manage your HeartView Health website.
        </p>
      </div>
      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          try {
            ...
            if (loginAdminWithEmail.fulfilled.match(result)) {
