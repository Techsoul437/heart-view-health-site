...
export default function ReportsListPage() {
    ...
    // LOAD REPORTS
    useEffect(() => {
        const storedReports = localStorage.getItem("staff-reports");
        if (storedReports) {
    ...
    const stats = useMemo(() => {
        ...
        const storedViews = localStorage.getItem("staff-report-views");
    ...
    const handleDelete = (id: number) => {
        ...
        localStorage.setItem("staff-reports", JSON.stringify(updatedReports));
    };
