...
const labId = Number(params.id);
    useEffect(() => {
        ...
        const lab = storedLabs.find(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (item: any) => item.id === labId
        );
...
">
    ...
    initialValues={{
        ...
        mobile: selectedLab?.mobile || "",
        alternateMobile: selectedLab?.alternateMobile || "",
        contactPerson: selectedLab?.contactPerson || "",
        branchName: selectedLab?.branchName || "",
        address: selectedLab?.address || "",
        city: selectedLab?.city || "",
        state: selectedLab?.state || "",
        pincode: selectedLab?.pincode || "",
        gstNumber: selectedLab?.gstNumber || "",
        panNumber: selectedLab?.panNumber || "",
        labLogo: selectedLab?.labLogo || null,
        licenseFile: selectedLab?.licenseFile || null,
    }}
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const updatedLabs = labs.map((lab: any) =>
        lab.id === labId
            ? { ...lab, ...values }
            : lab
    );
