...
export default function PatientsPage() {
    const [patients, setPatients] = useState<PatientItem[]>(() => {
        if (typeof window !== "undefined") {
            return JSON.parse(localStorage.getItem("heartview-admin-patients") || "[]");
        }
        return [];
    });
    ...
    const handleDelete = (id: number) => {
        ...
        localStorage.setItem("heartview-admin-patients", JSON.stringify(updatedPatients));
    };
    ...
    return (
        <div className="min-h-screen bg-white p-5 text-black md:p-12">
            ...
            <div className="flex flex-col gap-5   md:flex-row md:items-start md:justify-between ">
                ...
                <FillButton text="Add Patient" href="/heartview-admin/patients/add-patient" ></FillButton>
            ...
            <div className="mb-6 mt-5 grid grid-cols gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="flex items-center gap-4 rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="txt-sm text-[#64748B]">
                            {pct(femaleCount)}</p>
                    </div>
                </div>
                                ...
                                currentPatients.map((patient, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-5 py-4">
                                            <div className="flex items-center gap-2">
                                                <Link
                                                    href={`/heartview-admin/patients/add-patient/${patient.id}`}
