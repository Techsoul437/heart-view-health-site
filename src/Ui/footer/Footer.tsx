...
export default function Footer() {
  return (
    <footer className="w-full max-w-screen-8xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 2xl:px-20 py-10">

      <div className="rounded-2xl py-10 px-10 bg-gradient-to-r from-[#181E2B] to-[#3D7773]
